...
export default ({
  heading = "Bonds: Easy, Accessible & Smart Returns",
  description = "Our Bond Directory lets you compare, select and invest, all in one online place. Get the freedom to choose from a vast list of bonds for investment",
  primaryButtonText = "Go to Bond Directory",
  primaryButtonUrl = "#",
